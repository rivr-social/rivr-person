          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute z-10 right-3 top-1/2 -translate-y-1/2 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
